    ...
    return (
        <div>
          <NavbarTop>
            ...
            <Route path='/apparel' render={routeProps => <ProductsPage category='apparel' {...this.state} {...routeProps}/>}/>
            ...
            <Route path='/accessories' render={routeProps => <ProductsPage category='accessories' {...this.state} {...routeProps}/>}/>
            <Route path='/vintage' render={routeProps => <ProductsPage category='vintage' {...this.state} {...routeProps}/>}/>
